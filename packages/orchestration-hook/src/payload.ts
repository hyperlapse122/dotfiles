 ...
 * everyone body into each harness's instruction file; the build embeds the
 * same bytes here for the hook and extension paths. A second copy would be
 * the duplicate-knowledge defect this package exists to remove, so neither
 * body is vendored into src/.
 *
