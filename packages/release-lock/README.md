...
All upstream HTTP requests pass through the shared `fetchWithRetry` wrapper.
Transient failures — network and body-read errors, request timeouts, and HTTP
408, 425, 429, and 5xx responses — are retried automatically. Non-retryable
responses (2xx success, 3xx redirects, and client errors such as 404) return
