...
- **pi packages + model defaults**: `.chezmoidata/pi.yaml`. `pi.packages` renders
  ...
  scripts.
- **Agent MCP servers + dotagents remote skills**: `.chezmoidata/agents.yaml`.
