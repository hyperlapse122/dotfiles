...
- The maintainer will maintain the existing 1Password value at `op://Private/CLI Proxy API/password` as a generated single-line credential with at least 32 printable non-space ASCII characters and no double quote, backslash, newline, carriage return, or control character. A missing or invalid value is a fail-closed runtime condition, not a reason to substitute another secret.
