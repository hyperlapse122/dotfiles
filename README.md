...
> **Migrating off NixOS.** This repo is the new source of truth. Files previously generated by Home Manager are imported into `home/` and edited here directly — the old `~/nix-config` tree is being decommissioned. See [`AGENTS.md`](./AGENTS.md) for the migration contract.
